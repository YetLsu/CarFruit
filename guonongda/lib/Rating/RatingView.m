...
- (void)_initSubViews {
    ...
    UIImage *grayStarImage = [UIImage imageNamed:@"rate_G"];
    UIImage *yellowStarImage = [UIImage imageNamed:@"rate_R"];
...
//    [self addSubview:_ratingLabel];
    ...
    // 星星图案的宽度+标签宽度
//    myFrame.size.width = CGRectGetWidth(_grayStarView.frame)
//    + 45.f;
    myFrame.size.width = CGRectGetWidth(_grayStarView.frame);
    self.frame = myFrame;
}
